...
# System
include 'domtempl.php'; # DOMtempl
include 'dispatch.php'; # Dispatch
include 'form.php';     # Object/Array -> HTML form
include 'db.orm.php';   # DB, ORM
include 'common.php';   # Helpers
# Models
include 'models/files.php'; //<-- should not be used directly, inherit
include 'models/settings.php';
/* add other models here */

# Controllers
//include 'controllers/backup.php'; # Backup Manager
include 'controllers/dbmodels.php'; # Models Manager
